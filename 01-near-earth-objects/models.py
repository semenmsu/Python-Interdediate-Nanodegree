...
class NearEarthObject:
    ...
    def __str__(self):
        """Return `str(self)`."""
        return f"A NearEarthObject {self.designation} {self.name} \
            {self.diameter} {self.hazardous}"
...
class CloseApproach:
    ...
    def time_str(self):
        ...
        return f"A CloseApproach {self._designation} {tt} \
            {self.distance} {self.velocity}"

    def __str__(self):
        """Return `str(self)`."""

        return f"A CloseApproach {self._designation} {self.time} \
            {self.distance} {self.velocity}"
